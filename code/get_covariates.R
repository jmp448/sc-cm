...
for (d in cell_types) {
  ...
  saveRDS(t(v), paste0("../data/", d, "/exp_pcs.rds"))
  for (npc in seq(1,9)) {
    write.table(t(v[,1:npc]), file=paste0("../data/", d, "/", npc, "pcs.txt"),
